package com.lianda.movies.utils.custom
...
class CustomMultiStateView @JvmOverloads constructor(
    ...
    init {
        ...
        val a = getContext().obtainStyledAttributes(attrs, R.styleable.CustomMultiStateView)

        val loadingViewResId = a.getResourceId(R.styleable.CustomMultiStateView_loadingView, -1)
        ...
        val emptyViewResId = a.getResourceId(R.styleable.CustomMultiStateView_emptyView, -1)
        if (emptyViewResId > -1) {
        ...
        val errorViewResId = a.getResourceId(R.styleable.CustomMultiStateView_errorView, -1)
        if (errorViewResId > -1) {
